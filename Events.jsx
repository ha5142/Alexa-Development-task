...
function Events() {
    ...
    useEffect(() => {
        const newVisibleEvents = showMore ? events : events.slice(0, 6);
        setVisibleEventDescriptions(newVisibleEvents);
    }, [showMore]); // Only depends on showMore
